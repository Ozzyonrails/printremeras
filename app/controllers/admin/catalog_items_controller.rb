module Admin
  class CatalogItemsController < BaseController
    ...
    def item_params
      params.require(:catalog_item).permit(:template_id, :price_cents, :tags_string, title_translations: I18n.available_locales, description_translations: I18n.available_locales).to_h.tap do |h|
